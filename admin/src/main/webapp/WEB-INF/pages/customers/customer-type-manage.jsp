...
<div class="">
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Customer Type Manage</h6>
		</div>
		<div class="card-body">

			<form:form action="customer-type-manage.fxt" modelAttribute="customerTypeDTO"
				...
				<div class="row g-3">
					...
					<div class="col-md-4">
						...
						<span class="text-danger input-error-msg" data-label="Customer Type Name"></span>
					</div>
					...
					<div class="col text-left">
						...
						<c:if test="${not empty customerTypeDTO.id }">
								<button type="button" data-action="customer-type-delete.fxt"
									data-id="${customerTypeDTO.id }" class="btn btn-danger delete-data">Delete</button>
							</c:if>
					</div>
				</div>
			</form:form>
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<c:if test="${not empty customerTypeList }">
						<c:forEach items="${customerTypeList }" var="counter" varStatus="loop">
							<tr
