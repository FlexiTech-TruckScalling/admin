...
<div class="">
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Quantity Units</h6>
		</div>
		<div class="card-body">
			...
			<form:form action="quantity-units.fxt"
				...
				<div class="row g-3">
					<!-- Sequence -->
					<div class="col-md-4">
						<form:label path="pricePerUnit" class="form-label">Price Per Unit<strong
								class="text-danger">*</strong>
						</form:label>
				...
				<div class="row mt-4">
					<div class="col text-left">
						<button type="submit" class="btn btn-primary">${empty quantityUnitDTO.id ? "Save":"Update" }</button>
						<a href="weight-units.fxt" class="btn btn-secondary">Clear</a>
						<c:if test="${not empty quantityUnitDTO.id }">
							<button type="button" data-action="quantity-units-delete.fxt"
								data-id="${quantityUnitDTO.id }"
