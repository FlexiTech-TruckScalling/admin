...
<div class="">
	...
	<div class="card mb-4">
		<div class="card-header py-3">
			<span class="m-0 font-weight-bold text-secondary">User Shift
				List</span>
		</div>
		<div class="card-body">
						...
						<c:if test="${not empty shiftList}">
							<c:forEach items="${shiftList}" var="shift" varStatus="loop">
								<tr>
									...
									<td><span
										class="badge ${shift.shiftStatus == 1 ? 'badge-success' : 'badge-secondary'}">
											${shift.shiftStatus == 1 ? 'Active' : 'Completed'} </span></td>
									<td><a href="shift-detail.fxt?shiftId=${shift.id}"
